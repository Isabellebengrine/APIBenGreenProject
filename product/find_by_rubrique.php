...
// Récupérons l'id de la rubrique 
$product->rubrique_id = isset($_GET['rubrique_id']) ? $_GET['rubrique_id'] : die();

// le query
$stmt = $product->findByRubrique();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // On avertit l'utilisateur
        echo json_encode(array("message"=> "Aucun produit trouvé dans cette catégorie"));
}
